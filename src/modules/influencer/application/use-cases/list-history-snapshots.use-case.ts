...
import { ListHistorySnapshotsDto } from "../dtos/responses/list-history-snapshots.dto";
...
export class ListHistorySnapshotsUseCase{
    ...
    execute(dto:ListHistorySnapshotsDto){
        return this.influencerQueryService.historyInfluencerSnapshot(dto.userId,dto.page)
    }
}